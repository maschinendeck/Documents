...
% https://github.com/MartinScharrer/filemod
\usepackage{filemod}

\begin{document}

\newcommand{\associationName}{Maschinendeck} %Vereinsname (ohne e.V.)
\newcommand{\issuedOnDate}{20.09.2025}        %wann beschlossen

\newcommand{\membershipFeeOld}{15 \EUR}
\newcommand{\membershipFeeTier}{15 \EUR}         %Mitgliedsbeitrag legacy
\newcommand{\membershipFeeTierOne}{5 \EUR{}}     %Mitgliedsbeitrag Tier1
\newcommand{\membershipFeeTierTwo}{15 \EUR{}}    %Mitgliedsbeitrag Tier2
\newcommand{\membershipFeeTierThree}{25 \EUR{}}  %Mitgliedsbeitrag Tier3

\newcommand{\admissionFee}{10 \EUR{}}        %Aufnahmegebühr

\newcommand{\reminderFee}{5 \EUR{}}          %Mahngebühr

\newcommand{\contactMail}{office@maschinendeck.org} %e-mail Adresse für Änderungen der Mitgliedsdaten
...
\begin{enumerate}
  \item für reguläre Mitglieder beträgt \membershipFeeTierThree{}
  \item für Fördermitglieder beträgt mindestens \membershipFeeTierTwo{}
  \item Der ermäßigte Beitrag für den \associationName{} e.V. beträgt \membershipFeeTierOne{}\\
  (Gilt für Schüler, Auszubildende und Studenten. Ein entsprechender Nachweis ist vorzulegen)
\end{enumerate}
...
\Clause[title={Entrichtung der Beiträge}]
...
\Clause[title={Inkrafttreten/Übergangsbestimmungen}]

Die Fortzahlung des bisherigen Mitgliedsbeitrags vor der Änderung vom \issuedOnDate{}\ von \membershipFeeOld{}\  wird bis auf weiteres akzeptiert. Dies gilt für Mitglieder mit Beitrittsdatum vor dem 01.01.2020.

Reguläre Mitglieder mit Beitrittsdatum nach dem 01.01.2020, die weiterhin den bisherigen Mitgliedsbeitrag von \membershipFeeOld{}\ erbringen, werden bis auf Weiteres als Fördermitglieder betrachtet.
