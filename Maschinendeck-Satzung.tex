...
\subtitle{beschlossen am 23. Juli 2014} 
\author{} 
\date{} 
\maketitle
...
Der Verein führt den Namen \associationName{} und soll in das Vereinsregister eingetragen werden; nach der Eintragung führt er den Zusatz \glqq{}e.V.\grqq{}.
...
Der Verein verfolgt ausschließlich und unmittelbar gemeinnützige Zwecke im Sinne des Abschnittes \glqq{}Steuerbegünstigte Zwecke\grqq{} der Abgabenordnung.
...
\item Betrieb von Räumlichkeiten, die Vereinsmitgliedern und Außenstehenden zum kreativen Umgang mit Technik und zum gegenseitigen Informationsaustausch zur Verfügung stehen.    
\end{enumerate}
...
Im Falle nicht fristgerechter Entrichtung der Beiträge ruht die Mitgliedschaft bis zur Entrichtung aller ausstehenden Beiträge.
...
\item trifft Entscheidungen mit der einfachen Mehrheit der teilnehmenden Mitglieder. 
\item kann den Vereinszweck mit der Zustimmung aller teilnehmenden Mitglieder ändern. Der Änderungsantrag muss gemäß \ref{labA} erfolgen. Weiter wird bestimmt, dass \ref{labB} für Zweckänderungen keine Anwendung findet. Zweckänderungen können somit nicht durch Nachtrag zur Tagesordnung beschlossen werden. 
...
Der Vorstand wird von der Mitgliederversammlung für die Dauer von einem Jahr bestellt, er bleibt jedoch bis zur Bestellung eines neuen Vorstandes im Amt. Die Mitgliederversammlung kann vorzeitig einen neuen Vorstand wählen. Die Wiederwahl ist zulässig.
...
Bei höheren Ausgaben sind die Mitglieder vorher schriftlich oder per E-Mail zu unterrichten. Erfolgt innerhalb von zwei Wochen kein Widerspruch eines Mitglieds, gilt die Ausgabe als genemigt. Ansonsten entscheidet die Mitgliederversammlung.
